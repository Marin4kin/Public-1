...
<p> Для тестирования веб-приложения для учителей Skyeng были составлены и проведены следующие виды тестирования:<br>
...
<p> Задание 2.
Протестировать лифт в девятиэтажном доме.<br>  
Решение: в виде чеклиста перечислены функциональные и нефункциональные проверки, позитивные и негативные сценарии; также используется техника классов эквивалентности и граничных значений. Рассмотрены проверки юзабилити, безопасности, нагрузочное, стрессовое.</p> 
<p> Задание 3
Автомат принимает накопительные скидочные карты и при своем расчете учитывает количество баллов, по которому начисляет процент скидки: От 0 до 100 баллов — 1%; От 100 до 200 баллов — 3%; От 200 до 500 баллов — 5%; От 500 баллов — 10%. Необходимо составить набор тестовых данных для получения верной скидки.<br>
Составлены таблица классов эквивалентности, граничных значений и продуман набор тестовых данных для автомата. Есть вопросы к спецификации (поведение на гранце значений) В проекте 2 использованы таблицы GoogleSheets.</p> 
...
Также создать несколько негативных сценариев и убедиться, что при неправильных данных запрос возвращает соответствующий результат.<br>
...
<p> ✅ Проект 5.  Составление SQL-запросов - фрагмент с использованием фукции RANK OWER.</p>
...
<p> ✅ Проект 6: Тестирование веб-комнаты для занятий преподавателя (veb) с учеником (mobile) от Skyeng</p>
<p> Что нужно было сделать: Исследовать поведение системы браузер-приложение во время урока Преподавателя с Учеником по имеющимся сценариям. Провести тестирование разработаного функционала веб-комнаты и общее тестирование работы приложения во время использования на уроке. </p>
  
<p> Для тестирования веб-приложения для учителей Skyeng были составлены и проведены следующие виды тестирования:<br>

Функциональное (на уровне компонентов, интеграции и системы) <br>
...
![image](https://github.com/Marin4kin/Public-1/assets/132477713/9b2ecda6-fc8b-4b43-b096-e739cb60a32a)
  ...
  В данном проекте были использованы такие инструменты qase.io, Sitechco, Confluence, Jira, Postman, Android Studio.
   
<p>Итоги: В процессе выполнения проекта проведен полный цикл тестирования, далее на основе всего рассмотренного - собраны метрики тестирования, по ним хорошо видно, что продукт не совсем готов к релизу, обнаруженые дефекты могут негативно сказаться на оценке пользователем. Также сделаны предположения, как можно обойти имеющиеся недостатки (ученику тоже использовать пока веб версию и на ПК и на мобильном устройстве).</p>
 
  
 <p>Немного обо мне: есть среднее специальное образование ("Менеджмент и маркетинг") и высшее - "Минералогия и Геохимия" МГРИ-МГГРУ, при этом я работала в основном курьером и няней, сейчас учусь на QA-инженера и продаю этнические муз инструменты - бубны, диджериду), мне так не хватало нагрузки для ума) И вообще - нравится изучать новое в этом профиле, жду с нетерпением следующий рабочий проект.</p>
