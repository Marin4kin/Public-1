...
Все данные сохраняются в базу данных.<p>
    <p>При решении составлена таблица тстовых данных и написаны позитивные и негативные API тест-кейсы для проверки ручки регистрации и проверки наличия пользователя.<p>
...
Основные требования (главная user-story): Напишите позитивные и негативные тест-кейсы на проверку ручки регистрации. Пришлите ссылку на тест-кейсы.
...
Для запроса API на проверку ручки регистрации было составлено 2 позитивных и 7 негативных проверок;
Для запроса API для проверки наличия пользователя было составлено 5 позитивных и 8 негативных проверок
Использовались методы GET, POST, PATCH, PUT, DELETE.
На дополнительный вопрос о том, как бы проверила работу данного функционала на сайте, ответила, что провела бы функциональное тестирование, позитивные/негативные проверки, нефункциональное тестирование, например, UI/UX, безопасность.
В данном проекте были использованы такие инструменты "docs.google.com - Excel".
...
Провела 22 разных проверок;
Оформила API тест-кейсы
