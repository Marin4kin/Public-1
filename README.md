...
Задание 3:Тестирование API Яндекс.Погоды
...
Была создана коллекция с 5 запросами с методом GET: 2 запроса с позитивными данными и 3 запроса с негативными. Во вкладку "Variables" были занесены такие данные "BaseUrl", "ver", "MyKey", "tariff".
